...
const TESTS = [
  { id: "persoenlichkeit", name: "Persönlichkeitstest", emoji: "🧠", color: "#00E5FF", path: "/persoenlichkeit",
    hooks: ["Nur 2% der Menschen sind dieser Typ...","Der SELTENSTE Persönlichkeitstyp der Welt","Welcher der 16 Typen bist du WIRKLICH?","Dein Persönlichkeitstyp verrät ALLES über dich","Die meisten kennen ihren wahren Typ nicht...","POV: Du bekommst den seltensten Persönlichkeitstyp","Dieser Typ ist so selten dass die meisten ihn nicht kennen"],
    fragen: [
  ...
  { id: "rizz", name: "Rizz Score", emoji: "😏", color: "#FF0099", path: "/rizz",
    hooks: ["Dein RIZZ SCORE entscheidet alles","0 oder 100 — wie viel Rizz hast du?","Die WAHRHEIT über deinen Rizz Score","Rizz Level: Unspoken oder Cringe?","Dein Crush bewertet deinen Rizz...","W oder L? Dein Rizz Score sagt die Wahrheit"],
    fragen: [
  ...
  { id: "aura", name: "Aura Check", emoji: "✨", color: "#A855F7", path: "/aura",
    hooks: ["Welche AURA strahlst du aus?","Nur 3% haben eine GOLDENE Aura","Deine Aura-Farbe verrät dein wahres Ich","Die SELTENSTE Aura der Welt","Was sagt deine Energie über dich?"],
    fragen: [
  ...
  { id: "brainrot", name: "Brainrot Score", emoji: "🧟", color: "#00FF88", path: "/brainrot",
    hooks: ["Wie KAPUTT ist dein Gehirn?","Brainrot Score: 0 oder 100?","94% Brainrot... Hoffnung?","Dein Gehirn nach 5h TikTok","Sigma oder Skibidi? Dein Level"],
    fragen: [
  ...
  { id: "dark", name: "Dark Triad", emoji: "🖤", color: "#FF2255", path: "/dark",
    hooks: ["Wie DARK ist deine Persönlichkeit?","Narzissmus. Machiavellismus. Psychopathie.","Jeder hat eine dunkle Seite...","Traust du dich DIESEN Test?","Deine dunkle Seite in 3 Minuten enthüllt"],
    fragen: [
  ...
  { id: "npc", name: "NPC Test", emoji: "🤖", color: "#FFB800", path: "/npc",
    hooks: ["Bist du NPC oder MAIN CHARACTER?","90% der Menschen leben wie NPCs...","Main Character Energy oder NPC Dialog?","Lebst du oder existierst du nur?","NPC Check: Gleiche Route jeden Tag?"],
    fragen: [
  ...
  { id: "toxicity", name: "Toxicity Check", emoji: "☢️", color: "#FF6B35", path: "/toxicity",
    hooks: ["Von WHOLESOME bis BIOHAZARD","Wie TOXISCH bist du wirklich?","'Ich bin nicht toxisch, ich bin ehrlich'","Toxicity Level: Messbar. Erschreckend.","Dein Umfeld WEISS es schon..."],
    fragen: [
  ...
  { id: "redflag", name: "Red Flag Detector", emoji: "🚩", color: "#FF2255", path: "/redflag",
    hooks: ["Wie viele RED FLAGS hast du?","Die meisten haben 7+ ohne es zu wissen","Red Flag Detector: Dein Ergebnis wird WILD","Dein Date hat 3 Red Flags... und du?","Red Flag oder Green Flag? Der Test"],
    fragen: [
...
const TRENDS = [
  ...
  {name:"Red Flag Content",score:90,desc:"Dating Red Flags sind Dauerbrenner",rising:false,category:"Dating"},
    ...
    <div style={{minHeight:"100vh",background:"#060A14",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'DM Sans',system-ui,sans-serif"}}>
      <div style={{textAlign:"center",padding:32}}>
        ...
        <button onClick={()=>pw===PASSWORD?onLogin():setError(true)}
          style={{background:"linear-gradient(135deg,#00E5FF,#A855F7)",color:"#fff",border:"none",borderRadius:50,padding:"10px 32px",fontSize:13,fontWeight:700,cursor:"pointer",marginTop:12}}>
          Login
        </button>
  ...
  return (
    <div style={{minHeight:"100vh",background:"#060A14",fontFamily:"'DM Sans',system-ui,sans-serif",color:"#fff",maxWidth:600,margin:"0 auto",padding:"12px 16px"}}>
      ...
      <div style={{display:"flex",gap:6,marginBottom:16}}>
        {[{id:"generate",label:"⚡ Generator"},{id:"batch",label:"📦 Batch"},{id:"trends",label:"📈 Trends"},{id:"calendar",label:"📅 Posting Plan"}].map(t=>(
          <button key={t.id} onClick={()=>setTab(t.id)} style={{
            flex:1,background:tab===t.id?"rgba(0,229,255,0.15)":"rgba(22,28,53,0.7)",
            border:`1px solid ${tab===t.id?"#00E5FF":"#1A2040"}`,borderRadius:8,padding:"8px 4px",
            fontSize:10,fontWeight:700,color:tab===t.id?"#00E5FF":"#7A84A8",cursor:"pointer"
          }}>{t.label}</button>
        ))}
      </div>
